...
class WallStreetJournalNewsPage extends StatefulWidget {


  final ApiClient? api;
  const WallStreetJournalNewsPage({Key? key,this.api}) : super(key: key);

  @override
  _WallStreetJournalNewsPageState createState() => _WallStreetJournalNewsPageState();
}

class _WallStreetJournalNewsPageState extends State<WallStreetJournalNewsPage> {

  HomeScreenStore store = HomeScreenStore();

  @override
  void initState() {
    store.getWallStreetNews(widget.api!);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) {
        final wallStreetJournal = store.wallStreetNewsList?.status;
        switch (wallStreetJournal) {
          ...
          case FutureStatus.fulfilled:
            List<NewsModel> newsList = store.wallStreetNewsList?.result ?? [];
